...
- [ ] `src/BookstoreApi/BookstoreApi.csproj`: `Microsoft.EntityFrameworkCore.InMemory` uses floating version `8.*`, which makes builds non-reproducible and could pull in unexpected updates. Pin to a specific version (e.g., `8.0.11`) to ensure consistent, reproducible builds.
